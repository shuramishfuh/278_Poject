...
let plant = new Schema({
            ...
            use: {
                outdoor: {type: String, enum: outDoorUse},
                specialized: {type: String, enum: specialized},
                nativeEnvironment: {type: String, enum: nativeEnvironment},
                humanUse: {type: String, enum: HumanUse},
                building: {type: String, enum: building},
                required: true
            },
            shapeSize: {
            ...
            flower: {
                ...
                flower_img: {data: Buffer, contentType: String, required: true}
            },
            fruit: {
                color: {type: String, required: true, min: 5},
